<?php
    ...
    if(!isset($_SESSION['is_adminlogin']))
    {
        if(isset($_POST['login']))
        {
            ...
            $sql="Select mail, password from admin_login WHERE mail='$email' AND password='$password'";
...
<p class="text-center mt-4  shadow-lg p-4" style="font-size:20px; font-weight:bold"><i class="fas  fa-user-md mr-5"></i>Admin Login</p>
