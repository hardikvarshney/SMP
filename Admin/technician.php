<?php
    ...
    $sql="select * from technician_login";
...
<p class="bg-dark text-white text-center p-2">List of Technician</p>
...
{
    $sql="Delete from technician_login where id={$_REQUEST['id']}";
    $result=$con->query($sql);
    if($result == TRUE)
    { ?>
...
<div class=" col-sm-12">
    <a href="insert_tech.php" class="btn btn-danger float-right mr-3" style="margin-top:50px">
