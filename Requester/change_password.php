<?php
    ...
    if(isset($_REQUEST['change']))
    {
        ...
        else
        {
            ...
            $sql="Update requestor_login set password='$pass' where mail='$rEmail'";
            $result=$con->query($sql);
            if($result==TRUE)
            {
                $msg='<div class="alert alert-success text-danger text-center mt-2" role="alert">Password Successfully Changed</div>';
            }
            else
            {
